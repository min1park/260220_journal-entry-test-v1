...
const operatingItems: CFItem[] = [
  ...
  { id: 'op-adj-depr', parentId: 'op-adjust', sectionId: 'operating', label: '감가상각비', level: 3, isSubtotal: false, isEditable: true, order: 4, sign: -1, defaultCfCategories: ['operating'] },
  { id: 'op-adj-intang-amort', parentId: 'op-adjust', sectionId: 'operating', label: '무형자산상각비', level: 3, isSubtotal: false, isEditable: true, order: 5, sign: -1, defaultCfCategories: ['operating'] },
  { id: 'op-adj-invest-depr', parentId: 'op-adjust', sectionId: 'operating', label: '투자부동산감가상각비', level: 3, isSubtotal: false, isEditable: true, order: 6, sign: -1, defaultCfCategories: ['operating'] },
  { id: 'op-adj-bad-debt', parentId: 'op-adjust', sectionId: 'operating', label: '대손상각비(환입)', level: 3, isSubtotal: false, isEditable: true, order: 7, sign: -1, defaultCfCategories: ['operating'] },
  { id: 'op-adj-rou-depr', parentId: 'op-adjust', sectionId: 'operating', label: '사용권자산감가상각비', level: 3, isSubtotal: false, isEditable: true, order: 8, sign: -1, defaultCfCategories: ['operating'] },
  ...
  { id: 'op-wc-other-recv', parentId: 'op-wc', sectionId: 'operating', label: '미수금의 감소(증가)', level: 3, isSubtotal: false, isEditable: true, order: 32, sign: -1, defaultCfCategories: ['operating'] },
  { id: 'op-wc-prepaid', parentId: 'op-wc', sectionId: 'operating', label: '선급비용의 감소(증가)', level: 3, isSubtotal: false, isEditable: true, order: 33, sign: -1, defaultCfCategories: ['operating'] },
  { id: 'op-wc-advance', parentId: 'op-wc', sectionId: 'operating', label: '선급금의 감소(증가)', level: 3, isSubtotal: false, isEditable: true, order: 34, sign: -1, defaultCfCategories: ['operating'] },
  { id: 'op-wc-inventory', parentId: 'op-wc', sectionId: 'operating', label: '재고자산의 감소(증가)', level: 3, isSubtotal: false, isEditable: true, order: 35, sign: -1, defaultCfCategories: ['operating'] },
  // 운전자본-부채: sign = 1 (부채 증가 → CF 플러스)
  { id: 'op-wc-ap', parentId: 'op-wc', sectionId: 'operating', label: '매입채무의 증가(감소)', level: 3, isSubtotal: false, isEditable: true, order: 36, sign: 1, defaultCfCategories: ['operating'] },
  { id: 'op-wc-other-pay', parentId: 'op-wc', sectionId: 'operating', label: '미지급금의 증가(감소)', level: 3, isSubtotal: false, isEditable: true, order: 37, sign: 1, defaultCfCategories: ['operating'] },
  { id: 'op-wc-accrued', parentId: 'op-wc', sectionId: 'operating', label: '미지급비용의 증가(감소)', level: 3, isSubtotal: false, isEditable: true, order: 38, sign: 1, defaultCfCategories: ['operating'] },
  { id: 'op-wc-deposit-recv', parentId: 'op-wc', sectionId: 'operating', label: '예수금의 증가(감소)', level: 3, isSubtotal: false, isEditable: true, order: 39, sign: 1, defaultCfCategories: ['operating'] },
  { id: 'op-wc-advance-recv', parentId: 'op-wc', sectionId: 'operating', label: '선수금의 증가(감소)', level: 3, isSubtotal: false, isEditable: true, order: 40, sign: 1, defaultCfCategories: ['operating'] },
...
const investingItems: CFItem[] = [
  ...
  { id: 'inv-deposit-dec', parentId: 'inv-in', sectionId: 'investing', label: '정기예금의 감소', level: 2, isSubtotal: false, isEditable: true, order: 2, sign: -1, defaultCfCategories: ['investing'] },
  { id: 'inv-financial-dec', parentId: 'inv-in', sectionId: 'investing', label: '단기금융상품의 감소', level: 2, isSubtotal: false, isEditable: true, order: 3, sign: -1, defaultCfCategories: ['investing'] },
  { id: 'inv-loan-dec', parentId: 'inv-in', sectionId: 'investing', label: '대여금의 감소', level: 2, isSubtotal: false, isEditable: true, order: 4, sign: -1, defaultCfCategories: ['investing'] },
  { id: 'inv-guarantee-dec', parentId: 'inv-in', sectionId: 'investing', label: '보증금의 감소', level: 2, isSubtotal: false, isEditable: true, order: 5, sign: -1, defaultCfCategories: ['investing'] },
  { id: 'inv-ppe-dispose', parentId: 'inv-in', sectionId: 'investing', label: '유형자산의 처분', level: 2, isSubtotal: false, isEditable: true, order: 6, sign: -1, defaultCfCategories: ['investing'] },
  { id: 'inv-intang-dispose', parentId: 'inv-in', sectionId: 'investing', label: '무형자산의 처분', level: 2, isSubtotal: false, isEditable: true, order: 7, sign: -1, defaultCfCategories: ['investing'] },
  // (2) 투자활동으로 인한 현금유출액
  ...
  { id: 'inv-deposit-inc', parentId: 'inv-out', sectionId: 'investing', label: '정기예금의 증가', level: 2, isSubtotal: false, isEditable: true, order: 21, sign: -1, defaultCfCategories: ['investing'] },
  { id: 'inv-financial-inc', parentId: 'inv-out', sectionId: 'investing', label: '단기금융상품의 증가', level: 2, isSubtotal: false, isEditable: true, order: 22, sign: -1, defaultCfCategories: ['investing'] },
  { id: 'inv-loan-inc', parentId: 'inv-out', sectionId: 'investing', label: '대여금의 증가', level: 2, isSubtotal: false, isEditable: true, order: 23, sign: -1, defaultCfCategories: ['investing'] },
  { id: 'inv-guarantee-inc', parentId: 'inv-out', sectionId: 'investing', label: '보증금의 증가', level: 2, isSubtotal: false, isEditable: true, order: 24, sign: -1, defaultCfCategories: ['investing'] },
  { id: 'inv-ppe-acquire', parentId: 'inv-out', sectionId: 'investing', label: '유형자산의 취득', level: 2, isSubtotal: false, isEditable: true, order: 25, sign: -1, defaultCfCategories: ['investing'] },
  { id: 'inv-intang-acquire', parentId: 'inv-out', sectionId: 'investing', label: '무형자산의 취득', level: 2, isSubtotal: false, isEditable: true, order: 26, sign: -1, defaultCfCategories: ['investing'] },
  { id: 'inv-invest-prop', parentId: 'inv-out', sectionId: 'investing', label: '투자부동산의 취득', level: 2, isSubtotal: false, isEditable: true, order: 27, sign: -1, defaultCfCategories: ['investing'] },
  { id: 'inv-subsidiary', parentId: 'inv-out', sectionId: 'investing', label: '종속기업투자의 취득', level: 2, isSubtotal: false, isEditable: true, order: 28, sign: -1, defaultCfCategories: ['investing'] },
];
