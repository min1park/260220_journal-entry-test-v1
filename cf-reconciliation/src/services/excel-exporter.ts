...
export async function generateTBTemplate(): Promise<Blob> {
  ...
  const sampleData: (string | number)[][] = [
    ...
    ['1110', '단기금융상품', 100000000, 80000000, '유동자산', '투자-금융'],
    ['1210', '매출채권', 200000000, 230000000, '유동자산', '영업-자산'],
    ['1220', '대손충당금', -10000000, -12000000, '유동자산', '영업-조정'],
    ['1310', '재고자산', 150000000, 140000000, '유동자산', '영업-자산'],
    ['1410', '선급금', 20000000, 25000000, '유동자산', '영업-자산'],
    ['1420', '선급비용', 5000000, 6000000, '유동자산', '영업-자산'],

    // 비유동자산
    ['2110', '장기금융상품', 50000000, 60000000, '비유동자산', '투자-금융'],
    ['2210', '토지', 500000000, 500000000, '비유동자산', '투자-유형'],
    ['2220', '건물', 300000000, 350000000, '비유동자산', '투자-유형'],
    ['2221', '건물감가상각누계액', -30000000, -40000000, '비유동자산', '영업-조정'],
    ['2230', '기계장치', 200000000, 220000000, '비유동자산', '투자-유형'],
    ['2231', '기계장치감가상각누계액', -40000000, -55000000, '비유동자산', '영업-조정'],
    ['2240', '차량운반구', 50000000, 60000000, '비유동자산', '투자-유형'],
    ['2241', '차량운반구감가상각누계액', -20000000, -28000000, '비유동자산', '영업-조정'],
    ['2310', '소프트웨어', 30000000, 35000000, '비유동자산', '투자-무형'],
    ['2311', '소프트웨어상각누계액', -10000000, -15000000, '비유동자산', '영업-조정'],
    ['2410', '사용권자산', 100000000, 120000000, '비유동자산', '비현금'],
    ['2411', '사용권자산감가상각누계액', -20000000, -40000000, '비유동자산', '영업-조정'],

    // 유동부채
    ['3110', '매입채무', 80000000, 95000000, '유동부채', '영업-부채'],
    ['3120', '미지급금', 30000000, 35000000, '유동부채', '영업-부채'],
    ['3130', '미지급비용', 15000000, 18000000, '유동부채', '영업-부채'],
    ['3140', '선수금', 10000000, 12000000, '유동부채', '영업-부채'],
    ['3150', '예수금', 5000000, 6000000, '유동부채', '영업-부채'],
    ...
    ['4310', '퇴직급여충당부채', 80000000, 95000000, '비유동부채', '영업-조정'],
    ['4320', '이연법인세부채', 20000000, 25000000, '비유동부채', '영업-조정'],
